...
public class CalendarInfoImpl implements CalendarInfo {
    ...
    public CalendarInfoImpl(YearMonth yearMonth) {
    ...
    private String[][] fillTheArraysOfDates() {
        ...
        short firstWeek = 1;
        int firstDayOfWeekInMonth = yearMonth.atDay(firstDayOfMonth).getDayOfWeek().getValue();

        for (int week = firstWeek, date = firstDayOfMonth; week < ROWS; week++) {

            int firstDayOfWeek = week > firstWeek ? DayOfWeek.MONDAY.getValue() : firstDayOfWeekInMonth;
